...
#    def mean_iou_loss(self, y_true, y_pred):
#        """The metric function to be passed to the model.
...
#        # Takes numpy arrays as its arguments and returns numpy arrays as
#        # its outputs.
#        return tf.py_func(self._mean_iou_loss, [y_true, y_pred], tf.float32)
...
#    def _mean_iou_loss(self, y_true, y_pred):
#        return(1-self._mean_iou(y_true, y_pred))
